...
public class sossplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sossplash);
    ...
    private void navigateToNextActivity() {
        Intent intent = new Intent(sossplash.this, MainActivity.class);
